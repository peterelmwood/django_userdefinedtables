# Generated by Django 4.0.5 on 2022-08-02 12:23
...
import userdefinedtables.model_mixins
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=(userdefinedtables.model_mixins.OrderableMixin, models.Model),
        ),
        migrations.CreateModel(
            name='Entry',
            fields=[
        ...
        migrations.AddConstraint(
            model_name='column',
            constraint=models.UniqueConstraint(deferrable=django.db.models.constraints.Deferrable['DEFERRED'], fields=('list', 'index'), name='Two Columns cannot occupy the same index.'),
        ),
        migrations.AddField(
