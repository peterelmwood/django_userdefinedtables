# Generated by Django 4.0.5 on 2022-07-23 16:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_row', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='_prv_row', to='userdefinedtables.row')),
                ('previous_row', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='_nxt_row', to='userdefinedtables.row')),
            ],
        ),
        migrations.AddField(
            model_name='entry',
        ...
        migrations.AddConstraint(
            model_name='row',
            constraint=models.UniqueConstraint(condition=models.Q(('previous_row__isnull', True)), fields=('list', 'previous_row'), name='For any list, a row can only follow one or zero rows. A null row can be followed by exactlly one row, per list.'),
        ),
        migrations.AddConstraint(
            model_name='row',
            constraint=models.UniqueConstraint(condition=models.Q(('next_row__isnull', True)), fields=('list', 'next_row'), name='For any list, a row can only precede one or zero rows. A null row can be preceded by exactlly one row, per list.'),
        ),
        migrations.AddField(
