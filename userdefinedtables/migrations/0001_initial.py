...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='row',
            constraint=models.UniqueConstraint(condition=models.Q(('previous_row__isnull', True)), fields=('list', 'previous_row'), name='For any list, there can only be one starting row'),
        ),
        migrations.AddConstraint(
            model_name='row',
            constraint=models.UniqueConstraint(condition=models.Q(('next_row__isnull', True)), fields=('list', 'next_row'), name='For any list, there can only be one ending row'),
        ),
        migrations.AddField(
